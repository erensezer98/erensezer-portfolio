...
const FALLBACK: Project[] = [
  ...
  { id: '4', slug: 'csarda',            title: 'Csarda',               year: 2022, location: 'South Korea',     category: 'freelance', short_description: 'Pavilion design for the World Scout Jamboree in Saemangeum.',              description: '', tags: [], cover_image: null, images: [], featured: true,  order_index: 4, created_at: '' },
