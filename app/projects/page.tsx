...
const STATIC_PROJECTS: Project[] = [
  ...
  { id: '4', slug: 'hungarian-csarda',   title: 'Hungarian Csarda',    year: 2022, location: 'South Korea',     category: 'freelance', short_description: 'Pavilion design for a festival in Saemangeum, South Korea.',                                                 description: '', tags: ['pavilion', 'festival', 'temporary'],             cover_image: null, images: [], featured: true,  order_index: 4, created_at: '' },
